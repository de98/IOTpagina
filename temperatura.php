  <html>
    ...
    <body>
        ...
        if($us != "diego"){
            ...
            echo"<h3>Nodo  $nodo Valores establecidos por el Dr: $us</h3>";
        }
        if (($nodo == "1")){
        ...
        {
            $dec=$resp[$i];
            $temp=$dec ->temperatura;
            $fecha=$dec->fecha;
            echo "<table></tr><tr><td>$temp °C</td><td>$fecha</td></tr></table>";
        }

        header("Refresh: 2; URL='temperatura.php'");
        ...
        ?>
          ...
          <span style="position: absolute; top: 700px; left: 455px; ">
          <a href="pagina2IOT.php" class="boton_1">Volver</a>  
          </span>
          <span style="position: absolute; top: 700px; left: 875px; ">
